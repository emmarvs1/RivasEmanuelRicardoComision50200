...
def home(request):
            context = dashboard()
            return render(request, "aplicacion/home.html", context)
...
def servicios(request):
    ...
    return render(request, "aplicacion/servicios.html", context)
...
def serviciosForm(request):
    ...
    return render(request, "aplicacion/altaServicio.html", {"form": miForm })

@login_required
def buscarServ(request):
    alertasStatus = True
    contexto = {'alertasStatus': alertasStatus}
    return render(request, "aplicacion/buscarServ.html", contexto)
...
def facturas(request):
    ...
    return render(request, "aplicacion/facturas.html", context)

@login_required
def facturasPagas(request):
    alertasStatus = True
    context = {'facturas': Facturas.objects.all(), 'alertasStatus': alertasStatus} 
    return render(request, "aplicacion/facturaspagas.html", context)

@login_required
def buscarFact(request):
    alertasStatus = True
    contexto = {'alertasStatus': alertasStatus}
    return render(request, "aplicacion/buscarFact.html", contexto)
...
def facturasForm(request):
    ...
    return render(request, "aplicacion/altaFacturas.html", {"form": miForm })    
...
def listAbonados(request):
    alertasStatus = True
    context = {'aplicacion': Abonado.objects.all(), 'alertasStatus': alertasStatus} 
    return render(request, "aplicacion/listAbonados.html", context)    
...
def abonadosForm(request):
    if request.method == "POST":
        ...
        if miForm.is_valid():
            ...
            abonados.save()
            contexto = dashboard()
            return render(request, "aplicacion/listAbonados.html", contexto)

    else:    
        miForm = AltaAbonados()

    return render(request, "aplicacion/altaAbonados.html", {"form": miForm })

@login_required
def buscarAb(request):
    alertasStatus = True
    contexto = {'alertasStatus': alertasStatus}
    return render(request, "aplicacion/buscarAbonados.html", contexto)
...
def tickets(request):
    ...
    return render(request, "aplicacion/tickets.html", context)
...
def ticketsForm(request):
    if request.method == "POST":
        ...
        if miForm.is_valid():
            ...
            return render(request, "aplicacion/tickets.html", contexto)

    else:    
        miForm = AltaTickets()

    return render(request, "aplicacion/altaTickets.html", {"form": miForm })
...
def buscarT(request):
    alertasStatus = True
    contexto = {'alertasStatus': alertasStatus}
    return render(request, "aplicacion/buscarTicket.html", contexto)
